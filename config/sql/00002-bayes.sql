...
CREATE INDEX IF NOT EXISTS bayes_expire_idx1 ON bayes_expire (id);
...
CREATE UNIQUE INDEX IF NOT EXISTS bayes_global_vars_idx ON bayes_global_vars (variable);
INSERT INTO bayes_global_vars VALUES ('VERSION','3') ON CONFLICT DO NOTHING;
...
CREATE INDEX IF NOT EXISTS bayes_token_idx1 ON bayes_token (token);
...
CREATE UNIQUE INDEX IF NOT EXISTS bayes_vars_idx1 ON bayes_vars (username);
